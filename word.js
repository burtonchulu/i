...
loadAssets:function (){
	...
	var b = "win"+Loader.soundFileExtension;
	var c = "correct"+Loader.soundFileExtension;
	var d = "wrong"+Loader.soundFileExtension;

Game.backgroundSound = Loader.loadSound("background"+Loader.soundFileExtension);

Game.gameoverSound = Loader.loadSound("win"+Loader.soundFileExtension);

Game.correctSound = Loader.loadSound("correct"+Loader.soundFileExtension);

Game.wrongSound = Loader.loadSound("wrong"+Loader.soundFileExtension);
