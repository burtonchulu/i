...
init:function (){
	...
	if(sw<960){
		maincontainer.style.width = 0.95*sw+"px";
		maincontainer.style.height = 0.8*screen.height+"px";
		}
		else{
			maincontainer.style.width = 0.5*sw+"px";
			maincontainer.style.height = 0.5*sw+"px";
			}
...
if(Game.eny>Game.bulletcount.length){
	...
	toast.style.width = 0.95*screen.width+"px";
	toast.style.left = 0.5*screen.width-0.5*parseInt(toast.style.width)+"px";
	toast.style.top = "30%";
