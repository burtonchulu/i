...
var text = "Welcome to my portfolio.My name is Burton Chulu. I started learning web development in 2015.Along the way i have picked up numerous skills. I can code HTML5 CSS3 JavaScript Ajax PHP MySQL JSON and can do  Responsive design as well as mobile first approach.";

var text2 = "This portfolio is still under construction and will always be under continous development.This is so that it continously reflects my growing knowledge and skill set as i learn more.I am still putting together samples of some personal projects that i have worked on. For the meantime here is one of the earliest projects i worked on when i was still starting out.";
